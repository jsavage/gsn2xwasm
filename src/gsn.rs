...
mod test {
    ...
    fn serde_hor_index() -> Result<()> {
        let res: HorizontalIndex = serde_yaml_ng::from_str("!relative 5")?;
        assert_eq!(res, HorizontalIndex::Relative(5));
        let res: HorizontalIndex = serde_yaml_ng::from_str("!relative -3")?;
        assert_eq!(res, HorizontalIndex::Relative(-3));
        let res: HorizontalIndex = serde_yaml_ng::from_str("!relative 0")?;
        assert_eq!(res, HorizontalIndex::Relative(0));
        let res: HorizontalIndex = serde_yaml_ng::from_str("!absolute 0")?;
        assert_eq!(res, HorizontalIndex::Absolute(AbsoluteIndex::Number(0)));
        let res: HorizontalIndex = serde_yaml_ng::from_str("!absolute 7")?;
        assert_eq!(res, HorizontalIndex::Absolute(AbsoluteIndex::Number(7)));
        let res: HorizontalIndex = serde_yaml_ng::from_str("!absolute last")?;
    ...
    fn serde_hor_invalid_index() -> Result<()> {
        let res: Result<HorizontalIndex, _> = serde_yaml_ng::from_str("+asdf");
        assert!(res.is_err());
        let res: Result<HorizontalIndex, _> = serde_yaml_ng::from_str("");
        assert!(res.is_err());
        // 2**32 + 1
        let res: Result<HorizontalIndex, _> = serde_yaml_ng::from_str("4294967297");
        assert!(res.is_err());
        let res: Result<HorizontalIndex, _> = serde_yaml_ng::from_str("+4294967297");
        assert!(res.is_err());
        let res: Result<HorizontalIndex, _> = serde_yaml_ng::from_str("-4294967297");
        assert!(res.is_err());
        let res: Result<HorizontalIndex, _> = serde_yaml_ng::from_str("-x");
        assert!(res.is_err());
        let res: Result<HorizontalIndex, _> = serde_yaml_ng::from_str("bslkdf");
        assert!(res.is_err());
        let res: Result<HorizontalIndex, _> = serde_yaml_ng::from_str("!absolute null");
        assert!(res.is_err());
        let res: Result<HorizontalIndex, _> = serde_yaml_ng::from_str("!absolute");
        assert!(res.is_err());
        let res: Result<HorizontalIndex, _> = serde_yaml_ng::from_str("null");
        assert!(res.is_err());
        Ok(())
    }
...
horizontalIndex:
  relative: -23
"#;
        let res: GsnDocument = serde_yaml_ng::from_str(goal)?;
    ...
    #[test]
    fn nodetype() -> Result<()> {
        let nt: GsnNodeType = serde_yaml_ng::from_str("Solution")?;
...
C1:
  ...
  nodeType: Solution
"#;
        let res: BTreeMap<String, GsnDocument> = serde_yaml_ng::from_str(gsn)?;
...
G1:
  ...
  acp:
    ...
    - G2
"#;
        assert!(serde_yaml_ng::from_str::<BTreeMap<String, GsnDocument>>(gsn).is_err());
    }
